...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListeners(){
        ...
        with(binding){
            ...
            buttonSubstraction.setOnClickListener { onOperatorClicked(Operator.SUBTRACTION) }
    ...
    private fun onPercentageClicked(){
        if(inputValue2 == null) {
            ...
            val percentageOfValue1 = (getInputValue1() * getInputValue2()) / 10
    ...
    private fun updateInputOnDisplay(){
        ...
        binding.textEquation.text=equation
    }
